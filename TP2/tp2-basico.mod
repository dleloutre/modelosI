...
s.t. COSTO: COSTO_TOTAL = COSTO_PAISES_A_SAN_PABLO + COSTO_PAISES_A_PANAMA + COSTO_PAISES_A_NUEVA_YORK + COSTO_PAISES_A_AMSTERDAM + COSTO_PAISES_A_ESTAMBUL + COSTO_PAISES_A_TOKIO + COSTO_CENTROS_A_SAN_PABLO + COSTO_CENTROS_A_PANAMA + COSTO_CENTROS_A_NUEVA_YORK + COSTO_CENTROS_A_AMSTERDAM + COSTO_CENTROS_A_ESTAMBUL + COSTO_CENTROS_A_TOKIO + COSTO_CENTROS_A_VARSOVIA + COSTO_CENTROS_A_BRATISLAVA + COSTO_CENTROS_A_BUCAREST;
